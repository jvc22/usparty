...
export default function PostForm() {
    ...
    return (
        <div className="md:max-w-[500px] w-[100vw] mx-auto p-8 flex flex-col justify-center">
            <div>
                <p className="text-2xl text-center text-gray-100 font-bold md:hover:scale-110 md:hover:text-violet-500 duration-200 max-md:focus:text-violet-500 font-poppins">USParty</p>
            </div>
